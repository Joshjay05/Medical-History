...
const PatientDetails = () => {
  ...
  if (!selectedPatient) {
    return <p>Please select a patient to view details.</p>;
  }

  return (
    <section className="flex flex-col gap-8 px-4  py-12 bg-white rounded-lg shadow mb-8 ">
      ...
      <article>
        <div className="flex items-center gap-5 mb-4">
          ...
          <div>
            ...
            <p className="text-xs ">{selectedPatient?.date_of_birth}</p>
          </div>
        </div>
        <div className="flex items-center gap-5 mb-4">
          <svg
          ...
          <div>
            ...
            <p className="text-xs"> {selectedPatient?.gender}</p>
          </div>
        </div>
        <div className="flex items-center gap-5 mb-4">
          <svg
          ...
          <div>
            ...
            <p className="text-xs">{selectedPatient?.phone_number}</p>
          </div>
        </div>
        <div className="flex items-center gap-5 mb-4">
          <svg
          ...
          <div>
            ...
            <p className="text-xs">{selectedPatient?.emergency_contact}</p>
          </div>
        </div>
        <div className="flex items-center gap-5 mb-4">
          <svg
          ...
          <div>
            ...
            <p className="text-xs">{selectedPatient?.insurance_type}</p>
          </div>
        </div>
        <p className="text-sm text-gray-700 mt-4"></p>
      </article>

      <button className="bg-[#01F0D0] text-black py-2 px-4 rounded-3xl mt-4">
